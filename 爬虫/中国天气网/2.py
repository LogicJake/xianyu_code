...
for name in name_url:
    ...
    for index, date in enumerate(dates):
        ...
        city_num = len(
            html.xpath(
                '//div[@class="hanml"]/div[{}]/div[@class="conMidtab3"]'.
                format(index + 1)))

        for i in range(city_num):
            city = html.xpath(
                '//div[@class="hanml"]/div[{}]/div[@class="conMidtab3"][{}]/table/tr[1]/td[2]/a/text()'
                .format(index + 1, i + 1))[0]
            # 白天天气
            bttq = html.xpath(
                '//div[@class="hanml"]/div[{}]/div[@class="conMidtab3"][{}]/table/tr[1]/td[3]/text()'
                .format(index + 1, i + 1))[0]
            # 最高气温
            zgqw = html.xpath(
                '//div[@class="hanml"]/div[{}]/div[@class="conMidtab3"][{}]/table/tr[1]/td[5]/text()'
                .format(index + 1, i + 1))[0] + "℃"
            # 夜间天气
            yjtq = html.xpath(
                '//div[@class="hanml"]/div[{}]/div[@class="conMidtab3"][{}]/table/tr[1]/td[6]/text()'
                .format(index + 1, i + 1))[0]

            # 最低气温
            zdqw = html.xpath(
                '//div[@class="hanml"]/div[{}]/div[@class="conMidtab3"][{}]/table/tr[1]/td[8]/text()'
                .format(index + 1, i + 1))[0] + "℃"
